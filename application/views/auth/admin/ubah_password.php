...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url(); ?>assets/backend/images/logo/favicon-warma-white.png" type="image/x-icon">
    <!-- vendor css -->
    ...
    <div class="auth-content">
        ...
        <div class="card">
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        <h4 class="mb-2" style="font-size: 19px">Ubah Password</h4>
                        <p class="text-muted mb-5">Masukkan password baru anda</p>

                        <?= $this->session->userdata('message'); ?>

                        <form id="validation-form123" action="<?= site_url('auth/ubah_password_admin'); ?>" method="POST" class="text-left">
                            ...
                            <button class="btn btn-block btn-primary mb-4 font-weight-bold" type="submit">Ubah Password</button>
                        </form>
