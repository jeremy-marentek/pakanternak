                        ...
                        <div class="thumbnail">
                            <div class="thumb">
                                <a href="<?= base_url('upload/foto_user/' . $penjual['foto_penjual']); ?>" data-lightbox="1">
                                    <img src="<?= base_url('upload/foto_user/' . $penjual['foto_penjual']); ?>" alt="" class="img-fluid img-radius" width="142px" style="object-fit: cover; margin-top:28px;">
                                </a>
                            </div>
                        </div>
                        <h5 class="mt-4"><?= $penjual['nama_penjual']; ?></h5>
                        <p class="text-muted" style="margin-bottom: 16px;"><?= $penjual['email_penjual']; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="card">
                    ...
                    <!-- Form -->
                    <form action="<?= site_url('profile/ubah_password_penjual/' . $penjual['id_penjual']); ?>" method="POST">
                        <div class="card-body">
