                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <!-- Custom Input File -->
                            <input type="hidden" name="old_image" value="<?= site_url('upload/foto_produk/' . $produk['foto_produk']); ?>">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm" id="berat" name="berat" placeholder="Masukkan Berat Produk(Satuan Gram)" value="<?= $produk['berat_produk']; ?>">
                                    <?= form_error('stok', '<small class="text-danger font-weight-bold">', '</small>'); ?>
                                </div>
                            </div>
